...
export default function DestinationsPage() {
  ...
  const featuredDestinations = [
    ...
    },
    {
      id: 5,
      name: "Egypt",
      description: "Ancient wonders and pyramids",
  ...
  return (
    <main className="flex min-h-screen flex-col">
      ...
      <section className="relative h-[300px] md:h-[400px] w-full">
        ...
        <Image src="/images/sigiriya.jpg" alt="World destinations" fill className="object-cover" />
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-2">Explore by Continent</h2>
          <p className="text-center text-gray-600 mb-10">Find your perfect destination by region</p>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {continents.map((continent) => (
              <Link key={continent.id} href={`/destinations/continent/${continent.id}`}>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto">
          ...
          <p className="text-center text-gray-600 mb-10">Our most popular travel destinations</p>
